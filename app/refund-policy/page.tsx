  ...
  return (
    <PolicyPage
      ...
      sections={[
        ...
        { heading: "Written Requests", body: `Refund requests must be submitted in writing to ${site.email}. Please include your name, property address, payment date, and reason for the request.` },
        { heading: "Processing Timeline", body: "Approved refunds are generally processed within 5-10 business days. Actual posting time may vary by card issuer, bank, or payment provider." }
      ]}
    />
  );
}
